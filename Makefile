...
build-tf2-cpu:
	docker build -f Dockerfile.cpu \
		...
		--build-arg TORCHVISION_PIP="torchvision==0.9.2 -f https://download.pytorch.org/whl/cpu/torch_stable.html" \
...
build-cuda-11:
	docker build -f Dockerfile.gpu \
		...
		--build-arg TORCH_PIP="torch==1.8.1 -f https://download.pytorch.org/whl/cu111/torch_stable.html" \
		--build-arg TORCHVISION_PIP="torchvision==0.9.2 -f https://download.pytorch.org/whl/cu111/torch_stable.html" \
		--build-arg LIGHTNING_PIP="pytorch_lightning==1.2.0" \
